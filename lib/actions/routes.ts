...
export async function seedDemoRoutes() {
  ...
  const demoRoutes = [
    { route_code: "МАН-1042", from_city: "Актау", to_city: "Жанаозен", driver: "Ахмет С.", eta: "2ч 27м", progress: 68, status: "В пути" as const },
    { route_code: "МАН-1043", from_city: "Актау", to_city: "Каламкас", driver: "Батыр Ж.", eta: "6ч 00м", progress: 41, status: "В пути" as const },
    { route_code: "МАН-1044", from_city: "Жетыбай", to_city: "Жанаозен", driver: "Серик К.", eta: "1ч 18м", progress: 88, status: "Завершается" as const },
