...
const PEOPLE = [
  {
    name: "Ерлан Сейткали",
    role: "Логист, ТОО «Каспий Фуд», Актау",
    img: "https://images.unsplash.com/photo-1661688797823-36e97735223e?auto=format&fit=crop&w=300&h=300&q=80",
    quote:
      "Раньше машину искали обзвоном по знакомым — уходило полдня. Теперь заявка уходит в биржу, и перевозчик берёт её с телефона за минуты. По развозу в посёлки это сняло с нас целую ставку логиста.",
  },
  {
    name: "Асет Нуров",
    role: "ИП, перевозчик, Жанаозен",
    img: "https://images.unsplash.com/photo-1758599543242-31567fb8766e?auto=format&fit=crop&w=300&h=300&q=80",
    quote:
      "Главное — обратный груз. Раньше из Жанаозена возвращались пустыми почти всегда, это чистый минус по топливу и износу. Теперь система сама показывает, что можно забрать назад, и в тенге видно, сколько это стоит.",
  },
  {
    name: "Данияр Алиев",
    role: "Снабженец, ТОО «МангКурылыс», Жанаозен",
...
const LOGOS = ["Каспий Фуд", "Актауқұрылыс", "Мангистау Трейд", "МангКурылыс", "Ак Су", "Агроснаб Актау"]
        ...
        >
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            <p className="max-w-[200px] text-sm leading-relaxed text-sidebar-foreground/60">
              Отправители и перевозчики области — о том, что изменилось в их работе.
            </p>
