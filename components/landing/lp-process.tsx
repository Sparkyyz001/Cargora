...
const STEPS = [
  {
    ...
    desc: "Укажите откуда, куда, вес и сроки. Населённые пункты — из справочника области, расстояние подставится само.",
  },
  {
    no: "02",
    Icon: PackageCheck,
    title: "ИИ подбирает маршрут",
    desc: "Система подбирает свободную машину по типу кузова и грузоподъёмности — и сразу ищет перевозчику обратный груз.",
  },
  {
    no: "03",
    Icon: Ship,
    title: "Груз в движении",
    desc: "Машина на карте по реальной дороге — отслеживайте доставку в реальном времени.",
  },
  {
    no: "04",
    Icon: MapPin,
    title: "Груз доставлен",
    desc: "Груз выгружен в точке назначения, акт приёмки подтверждён в платформе.",
  },
]
