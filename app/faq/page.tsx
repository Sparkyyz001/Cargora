...
const FAQS = [
  ...
  { cat: "Перевозки по области",
    q: "Какие направления доступны через Cargora?",
    a: "Все перевозки внутри Мангистауской области: 15 населённых пунктов от Актау и Жанаозена до отдалённых Каламкаса, Сенека и Уштагана. Расстояния между ними посчитаны по реальному дорожному графу — 210 пар направлений." },
  { cat: "Перевозки по области",
    q: "Сколько времени занимает рейс?",
    a: "Актау → Акшукур — 25 минут, Актау → Курык — около часа, Актау → Жанаозен — 1 ч 53 мин, Актау → Бейнеу — 5 ч 33 мин. Для гружёного грузовика время умножается на 1.3." },
  { cat: "Перевозки по области",
    q: "Что такое обратная загрузка и зачем она нужна?",
    a: "Это встречный груз, который перевозчик берёт вместо порожнего возврата. Порожний возврат Актау → Жанаозен на тенте 20 т стоит перевозчику около 23 700 ₸ топлива и времени водителя. Cargora находит такой груз автоматически в момент открытия заявки и показывает экономию в тенге." },
  { cat: "Перевозки по области",
    q: "Как система подбирает машину?",
    a: "По типу кузова, грузоподъёмности и текущему положению машины. Рефрижератор может везти обычный груз, обратное — нет. Из подходящих выбирается та, у которой суммарная стоимость подачи и рейса минимальна." },
  { cat: "Перевозки по области",
    q: "Можно ли отслеживать машину в реальном времени?",
    a: "Да. На карте машина движется по реальной геометрии дороги, а не по прямой между точками. Отправитель видит положение груза и расчётное время прибытия." },
  // Тарифы
  { cat: "Тарифы и оплата",
    ...
    <div className="min-h-svh bg-background">
      ...
      <section className="relative overflow-hidden pt-36 pb-24 px-4 text-center">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-lg text-base leading-relaxed text-muted-foreground sm:text-lg">
            Всё о перевозках внутри Мангистауской области — от первой заявки до доставки груза.
          </p>
            ...
            <div className="flex flex-col justify-between gap-10 p-10 lg:border-r">
              <div>
                ...
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                  Напишите нам — ответим в течение часа и поможем отправить первый груз по области.
                </p>
              </div>
      ...
      <section className="px-4 pb-24">
        ...
        >
          ...
          >
            <p className="mb-3 text-xs font-bold uppercase tracking-widest opacity-70">Актау · Мангистауская область</p>
            <h2
            ...
            <p className="mt-5 max-w-sm text-sm leading-relaxed opacity-80">
              Регистрация за 5 минут. Система подберёт машину и обратный груз, перевозчик примет заявку — всё онлайн.
            </p>
            <Link
              href="/register"
